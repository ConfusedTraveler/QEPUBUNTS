...
dfk = pd.read_csv('pimax_etth1_NLZ2.csv', names=column_names, header=None)
dfcn = pd.read_csv('pimax_etth1_NLZ1.csv', names=column_names, header=None)
...
plt.legend(["Pimax_LZ2","Pimax_LZ1","Pi_lstm","Pi_cnnlstm"],fontsize=20)
plt.tight_layout()

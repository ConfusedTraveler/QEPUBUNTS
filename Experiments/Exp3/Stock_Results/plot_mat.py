...
if __name__ == "__main__":
	lengths = [1000,2000,3000,4000,5000,6000,7000,8200]
	...
	for l in lengths:
		file_path = f"../Results/PIMAX/stock{l}.csv"
	...
	for n in lengths:
		file_name = f"../OLD/OLD_Res/Arima/stock{n}.csv"  
